...
function dodaj() {
	...
	var input_zad = document.createElement("input");
	...
	input_zad.setAttribute("type", "text");
	input_zad.setAttribute("name", "zadanie[]");
	input_zad.setAttribute("placeholder", "Zadanie");
	...
	input_del.setAttribute("value", "Usuń zadanie");
