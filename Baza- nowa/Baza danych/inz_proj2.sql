...
--
-- Host: 127.0.0.1
-- Czas generowania: 21 Maj 2017, 14:42
...
INSERT INTO `role` (`id_roli`, `rola`, `id_projektu`) VALUES
(1, 'Grafik', 6),
(4, 'Kucharz', 6),
(5, 'Lekarz', 6),
(7, 'Biblotekarz', 6),
...
--
ALTER TABLE `dostepy`
  MODIFY `id_dostepu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `role`
  MODIFY `id_roli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `role`
  ADD CONSTRAINT `role_ibfk_1` FOREIGN KEY (`id_projektu`) REFERENCES `projekty` (`id_projektu`);
